...
function Page() {
  ...
  useEffect(() => {
    ...
    async function main() {
      ...
      try {
        rgbeLoader.load(
          new URL('@/assets/textures/environmentMap/2k.hdr', import.meta.url)
            .href,
          envMap => {
      ...
      const doorAmbientOcclusionTexture = textureLoader.load(
        new URL('@/assets/textures/door/ambientOcclusion.jpg', import.meta.url)
          .href,
      );
      ...
      const doorMetalnessTexture = textureLoader.load(
        new URL('@/assets/textures/door/metalness.jpg', import.meta.url).href,
      );
      const doorRoughnessTexture = textureLoader.load(
        new URL('@/assets/textures/door/roughness.jpg', import.meta.url).href,
      );
      const matcapTexture = textureLoader.load(
        new URL('@/assets/textures/matcaps/7.png', import.meta.url).href,
      );
